        ...
        return (
            <Form id="passwordForm" onSubmit={this.submitChangePassword}>
                <FormGroup>
                    ...
                    <Input autoComplete="password" type="password" onChange={(e) => this.setState({oldPasswordInput: e.target.value})} value={this.state.oldPasswordInput} name="oldPassword" id="oldPassword" placeholder="Old password" />
                </FormGroup>
                <FormGroup>
                    <Label for="newPassword">Password</Label>
                    <Input autoComplete="new-password" type="password" onChange={(e) => this.setState({newPasswordInput: e.target.value})} value={this.state.newPasswordInput} name="newPassword" id="newPassword" placeholder="New password" />
                </FormGroup>
