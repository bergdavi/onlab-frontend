                ...
                <ModalBody>
                    <Form id="loginForm" onSubmit={this.submitLogin}>
                        <FormGroup>
                            ...
                            <Input type="text" autoComplete="username" onChange={(e) => this.setState({loginUsernameInput: e.target.value})} value={this.state.loginUsernameInput} name="username" id="loginUsername" placeholder="Username" />
                        </FormGroup>
                        <FormGroup>
                            <Label for="loginPassword">Password</Label>
                            <Input type="password" autoComplete="password" onChange={(e) => this.setState({loginPasswordInput: e.target.value})} value={this.state.loginPasswordInput} name="password" id="loginPassword" placeholder="Password" />
                        </FormGroup>
